...
foods = ["pizza","chicken","ramen","BBQ","Burger"]
...
# Q: What happens? Why?
#python cant find value in list
...
# trying to remove item not in the dictionary
...
friends = [
    {"name": "Jason", "favorite_food": "sushi"},
    {"name": "Junsang", "favorite_food": "burgers"},
    {"name": "David", "favorite_food": "pasta"}
]

# TODO: Print the favorite food of the second friend.
print(f"{friends[1]['favorite_food']}")
